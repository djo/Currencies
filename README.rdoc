...
http://webservicex.net/country.asmx

Due to the web service is often unavailable you can get the Currencies Loader Exception.
In this case just try ivoke the task:
